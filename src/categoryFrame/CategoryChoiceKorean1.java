...
public class CategoryChoiceKorean1 extends JPanel {

	public CategoryChoiceKorean1() {

	}

	public CategoryChoiceKorean1(FoodDAO foodDao) {
...
//		setBackground(new Color(255,165,0));
		...
		ImageIcon buttonImagefood1 = new ImageIcon(KOREAN_01);
		ImageIcon buttonImagefood2 = new ImageIcon(KOREAN_02);
		ImageIcon buttonImagefood3 = new ImageIcon(KOREAN_03);
		ImageIcon buttonImagefood4 = new ImageIcon(KOREAN_04);
		ImageIcon buttonImagefood5 = new ImageIcon(KOREAN_05);
		ImageIcon buttonImagefood6 = new ImageIcon(KOREAN_06);
...
//		btnFood1.add(get("LineBorder", border));
		...
		// 장소
		JLabel FoodPlace1 = new JLabel("▶ 음식: " + foodDao.Info().get(0).getFoodName());
		JLabel FoodPlace2 = new JLabel("▶ 음식: " + foodDao.Info().get(1).getFoodName());
		JLabel FoodPlace3 = new JLabel("▶ 음식: " + foodDao.Info().get(2).getFoodName());
		JLabel FoodPlace4 = new JLabel("▶ 음식: " + foodDao.Info().get(3).getFoodName());
		JLabel FoodPlace5 = new JLabel("▶ 음식: " + foodDao.Info().get(4).getFoodName());
		JLabel FoodPlace6 = new JLabel("▶ 음식: " + foodDao.Info().get(5).getFoodName());
...
//		add(btnBackPage);
		...
		btnFood1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 0));
			}
		});
		...
		btnFood2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 1));
			}
		});
		...
		btnFood3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 2));
			}
		});
		...
		btnFood4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 3));
			}
		});
		...
		btnFood5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 4));
			}
		});
		...
		btnFood6.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "한식", 5));
			}
		});
		...
		btnNextPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceKorean2(new FoodDAO()));
			}
		});
	}
}
...
public class CategoryChoiceAllFood3 extends JPanel {

	public CategoryChoiceAllFood3() {

	}

	public CategoryChoiceAllFood3(FoodDAO foodDao) {
		setBackground(new Color(255, 250, 190));
		setLayout(null);
		setSize(585, 765);

		ImageIcon buttonImagefood1 = new ImageIcon(CHINESE_01);
		ImageIcon buttonImagefood2 = new ImageIcon(CHINESE_02);
		ImageIcon buttonImagefood3 = new ImageIcon(CHINESE_03);
		ImageIcon buttonImagefood4 = new ImageIcon(CHINESE_04);
		ImageIcon buttonImagefood5 = new ImageIcon(CHINESE_05);
		ImageIcon buttonImagefood6 = new ImageIcon(CHINESE_06);
		...
		// 장소
		JLabel FoodPlace1 = new JLabel("▶ 음식: " + foodDao.Info().get(10).getFoodName());
		JLabel FoodPlace2 = new JLabel("▶ 음식: " + foodDao.Info().get(11).getFoodName());
		JLabel FoodPlace3 = new JLabel("▶ 음식: " + foodDao.Info().get(12).getFoodName());
		JLabel FoodPlace4 = new JLabel("▶ 음식: " + foodDao.Info().get(13).getFoodName());
		JLabel FoodPlace5 = new JLabel("▶ 음식: " + foodDao.Info().get(14).getFoodName());
		JLabel FoodPlace6 = new JLabel("▶ 음식: " + foodDao.Info().get(15).getFoodName());
...
//		btnFood6.setFocusPainted(true);
		...
		btnFood1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 10));
			}
		});
		...
		btnFood2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 11));
			}
		});
		...
		btnFood3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 12));
			}
		});
		...
		btnFood4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 13));
			}
		});
		...
		btnFood5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 14));
			}
		});
		...
		btnFood6.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 15));
			}
		});
		...
		btnBackPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceAllFood2(new FoodDAO()));
			}
		});
	}
}
...
public class CategoryChoiceAllFood8 extends JPanel {

	public CategoryChoiceAllFood8() {

	}

	public CategoryChoiceAllFood8(FoodDAO foodDao) {
		setBackground(new Color(255, 250, 190));
		setLayout(null);
		setSize(585, 765);

		ImageIcon buttonImagefood1 = new ImageIcon(AMERICAN_07);
		ImageIcon buttonImagefood2 = new ImageIcon(AMERICAN_08);
		ImageIcon buttonImagefood3 = new ImageIcon(AMERICAN_09);
		ImageIcon buttonImagefood4 = new ImageIcon(AMERICAN_10);
		...
		// 장소
		JLabel FoodPlace1 = new JLabel("▶ 음식: " + foodDao.Info().get(36).getFoodName());
		JLabel FoodPlace2 = new JLabel("▶ 음식: " + foodDao.Info().get(37).getFoodName());
		JLabel FoodPlace3 = new JLabel("▶ 음식: " + foodDao.Info().get(38).getFoodName());
		JLabel FoodPlace4 = new JLabel("▶ 음식: " + foodDao.Info().get(39).getFoodName());
...
//		add(btnNextPage);
		...
		btnFood1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 36));
			}
		});
		...
		btnFood2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 37));
			}
		});
		...
		btnFood3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 38));
			}
		});
		...
		btnFood4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 39));
			}
		});

...
public class CategoryChoiceAllFood7 extends JPanel {

	public CategoryChoiceAllFood7() {

	}

	public CategoryChoiceAllFood7(FoodDAO foodDao) {
...
//		btnFood6.setFocusPainted(true);
		...
		btnNextPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceAllFood8(new FoodDAO()));
			}
		});

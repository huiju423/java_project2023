...
public class CategoryChoiceAllFood4 extends JPanel {

	public CategoryChoiceAllFood4() {

	}

	public CategoryChoiceAllFood4(FoodDAO foodDao) {
		setBackground(new Color(255, 250, 190));
		setLayout(null);
		setSize(585, 765);

		ImageIcon buttonImagefood1 = new ImageIcon(CHINESE_07);
		ImageIcon buttonImagefood2 = new ImageIcon(CHINESE_08);
		ImageIcon buttonImagefood3 = new ImageIcon(CHINESE_09);
		ImageIcon buttonImagefood4 = new ImageIcon(CHINESE_10);
		...
		// 장소
		JLabel FoodPlace1 = new JLabel("▶ 음식: " + foodDao.Info().get(16).getFoodName());
		JLabel FoodPlace2 = new JLabel("▶ 음식: " + foodDao.Info().get(17).getFoodName());
		JLabel FoodPlace3 = new JLabel("▶ 음식: " + foodDao.Info().get(18).getFoodName());
		JLabel FoodPlace4 = new JLabel("▶ 음식: " + foodDao.Info().get(19).getFoodName());
...
//		btnFood4.setFocusPainted(false);
		...
		btnFood1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 16));
			}
		});
		...
		btnFood2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 17));
			}
		});
		...
		btnFood3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 18));
			}
		});
		...
		btnFood4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "중식", 19));
			}
		});
		...
		btnBackPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceAllFood3(new FoodDAO()));
			}
		});

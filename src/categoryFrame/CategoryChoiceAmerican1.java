...
public class CategoryChoiceAmerican1 extends JPanel {

	public CategoryChoiceAmerican1() {

	}

	public CategoryChoiceAmerican1(FoodDAO foodDao) {
		setBackground(new Color(255, 250, 190));
		setLayout(null);
		setSize(585, 765);
		
		ImageIcon buttonImagefood1 = new ImageIcon(AMERICAN_01);
		ImageIcon buttonImagefood2 = new ImageIcon(AMERICAN_02);
		ImageIcon buttonImagefood3 = new ImageIcon(AMERICAN_03);
		ImageIcon buttonImagefood4 = new ImageIcon(AMERICAN_04);
		ImageIcon buttonImagefood5 = new ImageIcon(AMERICAN_05);
		ImageIcon buttonImagefood6 = new ImageIcon(AMERICAN_06);
		...
		// 장소
		JLabel FoodPlace1 = new JLabel("▶ 음식: " + foodDao.Info().get(30).getFoodName());
		JLabel FoodPlace2 = new JLabel("▶ 음식: " + foodDao.Info().get(31).getFoodName());
		JLabel FoodPlace3 = new JLabel("▶ 음식: " + foodDao.Info().get(32).getFoodName());
		JLabel FoodPlace4 = new JLabel("▶ 음식: " + foodDao.Info().get(33).getFoodName());
		JLabel FoodPlace5 = new JLabel("▶ 음식: " + foodDao.Info().get(34).getFoodName());
		JLabel FoodPlace6 = new JLabel("▶ 음식: " + foodDao.Info().get(35).getFoodName());
...
//		add(btnBackPage);
		...
		btnFood1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 30));
			}
		});
		...
		btnFood2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 31));
			}
		});
		...
		btnFood3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 32));
			}
		});
		...
		btnFood4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 33));
			}
		});
		...
		btnFood5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 34));
			}
		});
		...
		btnFood6.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new FoodReservation2(new FoodDAO(), "양식", 35));
			}
		});
		...
		btnNextPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceAmerican2(new FoodDAO()));
			}
		});
	}
}
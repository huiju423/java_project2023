...
public class CategoryChoiceChinese1 extends JPanel {

	public CategoryChoiceChinese1() {

	}

	public CategoryChoiceChinese1(FoodDAO foodDao) {
...
//		add(btnBackPage);
		...
		btnNextPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceChinese2(new FoodDAO()));
			}
		});
	}
}
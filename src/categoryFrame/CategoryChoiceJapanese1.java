...
public class CategoryChoiceJapanese1 extends JPanel {

	public CategoryChoiceJapanese1() {

	}

	public CategoryChoiceJapanese1(FoodDAO foodDao) {
...
//		add(btnBackPage);
		...
		btnNextPage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FoodBase.getDispose();
				FoodBase.getInstance(new CategoryChoiceJapanese2(new FoodDAO()));
			}
		});
	}
}